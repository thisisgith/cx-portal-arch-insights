...
const ieSlides: Slide[] = [
	{
		buttonText: I18n.get('_IveDoneThis_'),
		content: I18n.get('_SetupInstruction_12A_'),
		src: 'assets/img/setup-ie/FinalThickClient/Setting_CX_Collector_Password.mp4',
	...
	},
	{
		...
		src: 'assets/img/setup-ie/FinalThickClient/Confirmation_ScreenGrab_cropped.png',
		stepLabel: I18n.get('_CiscoCXCollector_'),
		stepNum: 3,
		type: 'image',
	},
	{
		...
		src: 'assets/img/setup-ie/FinalThickClient/Configuration_ScreenGrab_cropped.png',
		stepLabel: I18n.get('_CiscoCXCollector_'),
		stepNum: 3,
		type: 'image',
	},
	{
		...
		content: I18n.get('_SetupInstruction_11A_'),
		src: 'assets/img/setup-ie/FinalThickClient/Final_Confirmation of_IP.png',
		stepLabel: I18n.get('_CiscoCXCollector_'),
		stepNum: 3,
		type: 'image',
	},
