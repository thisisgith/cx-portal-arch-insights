...
/**
 * Main component for the Architecture Bar Chart
 */
@Component({
	selector: 'architecture-bar-chart',
	styleUrls: ['./architecture-bar-chart.component.scss'],
	templateUrl: './architecture-bar-chart.component.html',
})
export class ArchitectureBarChartComponent implements OnInit {
