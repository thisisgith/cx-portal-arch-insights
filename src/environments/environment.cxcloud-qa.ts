...
export const environment = {
	...
	rmaServiceOrigin: 'https://api-test.cisco.com/api/qa/customerportal',
	rmaServicePaths: {
	 ...
	 */
	sdpServiceOrigin: 'https://api-test.cisco.com/api/qa/customerportal',
	sdpServicePaths: {
		contracts: '/api/qa/v1/contracts',
		controlpoints: '/api/qa/customerportal/controlpoint',
		customerportal: '/api/qa/customerportal',
		inventory: '/api/qa/v1/inventory',
	},
