...
export { ControlPointApiControllerService } from './services/control-point-api-controller.service';
...
export { ControlPointDeviceDiscoveryAPIToRemoveInventoryService } from './services/control-point-device-discovery-apito-remove-inventory.service';
