...
class EntitlementService extends __BaseService {
  ...
  getUserResponse(): __Observable<__StrictHttpResponse<User>> {
    ...
    let req = new HttpRequest<any>(
      'GET',
      this.rootUrl + `/api/customerportal/entitlement/v1/user`,
      __body,
      {
        headers: __headers,
        params: __params,
  ...
  getUserAffiliationResponse(customerId: string): __Observable<__StrictHttpResponse<Affiliation>> {
    ...
    let req = new HttpRequest<any>(
      'GET',
      this.rootUrl + `/api/customerportal/entitlement/v1/user/party/affiliation/${customerId}`,
      __body,
      {
        headers: __headers,
        params: __params,
  ...
  getServiceInfoResponse(customerId: string): __Observable<__StrictHttpResponse<ServiceInfoResponse>> {
    ...
    let req = new HttpRequest<any>(
      'GET',
      this.rootUrl + `/api/customerportal/entitlement/v1/party/service-info/${customerId}`,
      __body,
      {
        headers: __headers,
        params: __params,
  ...
  getServiceInfoBySerialResponse(params: EntitlementService.GetServiceInfoBySerialParams): __Observable<__StrictHttpResponse<ServiceInfoResponse>> {
    ...
    let req = new HttpRequest<any>(
      'GET',
      this.rootUrl + `/api/customerportal/entitlement/v1/party/service-info/product/${params.serialNumber}`,
      __body,
      {
        headers: __headers,
        params: __params,
